...
class Iguana(token):
    ...
    def get(cls, fonte=None, datainicio=None, 
        ...
        assert(cls.token is not None), ("É preciso inserir um token válido!" +
    ...
    def uncertainty_get(cls, fonte=None, datainicio=None,
    ...
    def reader(cls, start, end, cenario = [1,2,3]):
